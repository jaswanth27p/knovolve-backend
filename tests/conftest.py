...
def clean_db():
    ...
    with SessionLocal() as s:
        s.execute(text(
            "TRUNCATE refresh_tokens, users, assignment_questions, assignments, "
            "chapter_content_sections, chapter_contents, concept_edges, concepts, chapters, "
            "modules, course_jobs, courses, user_courses, checkpoint_writes, checkpoint_blobs, "
